...
public class MainActivity extends Activity {
    ...
    private void findContact(String name) {
        ...
        try {
            ...
            speak(
                    "Contacts search मध्ये समस्या आली"
            );
